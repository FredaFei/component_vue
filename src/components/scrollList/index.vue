<template>
    <section class="scrollBox" ref="scrollList">
        <div class="scroll-content" v-show="dataList.length>1">
            ...
            <div class="scroll-ft">
                ...
                <div v-if="bottomStatus=='in'">数据加载中...</div>
                <div v-if="bottomStatus=='more'">查看更多</div>
            </div>
        </div>
        <div class="list-empty" v-show="data.length == 0">
...
<script>
    ...
    import noData from '@/xx/noData/index.vue'
    // const mixin = {
    //     props: ['dataList']
    // }
    export default {
